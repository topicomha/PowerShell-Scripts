<#
 ...
 $script:ChannelBasePath="https://www.youtube.com/feeds/videos.xml?channel_id="
 
function Read-YoutubeFeed {
	param (
		...
		if (!$PSBoundParameters.ContainsKey('FeedURL') -and !$PSBoundParameters.ContainsKey('ChannelID') -and !$PSBoundParameters.ContainsKey('FilePath')) {
			...
			if ($PSBoundParameters.ContainsKey('FilePath')) {
				...
				if (!$PSBoundParameters.ContainsKey('FeedURL') -and $PSBoundParameters.ContainsKey('ChannelID')) {
					$Url = "$script:ChannelBasePath$ChannelID"
				}
				else {
					$Url = $FeedURL
					$split = $Url.Split("=")
...
#Export-ModuleMember -Function Read-YoutubeFeed
